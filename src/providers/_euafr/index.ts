...
import { Country, CountryInfo, findCountryByAlpha2 } from "../../transform/country";
...
> = {
  ...
  Finland: { property: CodeIssuer.UIC }, // [0-9]{5}
  Italy: { property: CodeIssuer.UIC },
  Spain: { property: CodeIssuer.UIC },
  ...
  Slovenia: { property: CodeIssuer.UIC },
  "The Netherlands": { property: Property.StationCode },
  "United Kingdom": {
  ...
  Sweden: { property: Property.StationCode },
