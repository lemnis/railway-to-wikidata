...
<script>
  ...
  fetch('https://raw.githubusercontent.com/lemnis/railway-to-wikidata/master/geojson/tracks/BG.geojson').then(data => data.json()).then(data => map.addLayer(L.geoJson(data)));
</script>
